...
function AdminPageContent() {
  ...
  const [formData, setFormData] = useState<
    Omit<BlogPost, 'id' | 'date' | 'likes' | 'comments'>
  >({
    title: '',
    excerpt: '',
    content: '',
  ...
  // Einzig gültiger Delete-Handler für Posts
  ...
  const handleAddAnimalType = () => {
    if (newAnimalType.name && newAnimalType.icon) {
      const newType: AnimalType = {
        id: Date.now(), // AnimalType-IDs bleiben number
  ...
  const handleAddUser = () => {
    if (newUser.email && newUser.password && newUser.name) {
      const user = {
        id: crypto.randomUUID(), // Benutzer-IDs als string
        email: newUser.email,
  ...
  const handleDeleteUser = (id: string) => {
    if (!confirm('Bist du sicher, dass du diesen Benutzer löschen möchtest?')) return;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-2">
              <img src="/image copy copy.png" alt="Tier-Check Logo" className="h-8 w-auto" />
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold text-orange-900 mb-2">Blog-Verwaltung</h1>
              <p className="text-xl text-orange-800">Verwalte deine Blog-Artikel und erstelle neue Inhalte</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {showEditor ? (
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-xl shadow-lg p-8 mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900">{editingPost ? 'Artikel bearbeiten' : 'Neuen Artikel erstellen'}</h2>
              <div className="flex items-center space-x-3">
                <motion.button
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">URL-Slug (automatisch generiert)</label>
                  <input
                    type="text"
                    value={formData.slug}
                    ...
                    <div className="space-y-3">
                      {formData.affiliateProducts.map((product, index) => (
                        <div key={index} className="flex items-center justify-between bg-gray-50 p-3 rounded-lg">
                          ...
                          <button type="button" onClick={() => removeAffiliateProduct(index)} className="text-red-600 hover:text-red-800 p-1">
                            <X size={16} />
                          </button>
                        </div>
                      ))}
  ...
  value={currentAffiliateProduct.image ?? ''}
  onChange={(url: string) =>
    setCurrentAffiliateProduct(p => ({ ...p, image: url ?? '' }))
  }
  label="Produkt-Bild"
  placeholder="Oder Bild-URL eingeben..."
/>
  ...
  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
    setCurrentAffiliateProduct(p => ({ ...p, url: e.target.value }))
  }
  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
...
/>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        step="0.1"
                        value={currentAffiliateProduct.rating ?? 0}
                        onChange={(e) =>
                          setCurrentAffiliateProduct({ ...currentAffiliateProduct, rating: parseFloat(e.target.value) })
                        }
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setCurrentAffiliateProduct({ ...currentAffiliateProduct, buttonText: e.target.value })
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setCurrentAffiliateProduct({ ...currentAffiliateProduct, buttonColor: e.target.value })
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setCurrentAffiliateProduct({ ...currentAffiliateProduct, buttonStyle: e.target.value })
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                        >
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Button-Größe</label>
                        <select
                          value={currentAffiliateProduct.buttonSize || 'medium'}
                          onChange={(e) =>
                            setCurrentAffiliateProduct({ ...currentAffiliateProduct, buttonSize: e.target.value })
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setCurrentAffiliateProduct({ ...currentAffiliateProduct, buttonIcon: e.target.value })
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setCurrentAffiliateProduct({ ...currentAffiliateProduct, buttonAnimation: e.target.value })
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                        >
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Button-Vorschau</label>
                        <div className="border border-gray-300 rounded-lg p-4 bg-gray-50">
                          <motion.button
                            className={`flex items-center justify-center space-x-2 font-semibold rounded-lg shadow-lg transition-all duration-300
                              ${
                                currentAffiliateProduct.buttonSize === 'small'
                                  ? 'px-3 py-2 text-sm'
                                  : currentAffiliateProduct.buttonSize === 'large'
                                  ? 'px-6 py-4 text-lg'
                                  : 'px-4 py-3 text-base'
                              }
                              ${
                                currentAffiliateProduct.buttonStyle === 'outline'
                                  ? `border-2 bg-transparent ${
                                      currentAffiliateProduct.buttonColor === 'green'
                                        ? 'border-green-600 text-green-600 hover:bg-green-50'
                                        : currentAffiliateProduct.buttonColor === 'blue'
                                        ? 'border-blue-600 text-blue-600 hover:bg-blue-50'
                                        : currentAffiliateProduct.buttonColor === 'orange'
                                        ? 'border-orange-600 text-orange-600 hover:bg-orange-50'
                                        : currentAffiliateProduct.buttonColor === 'red'
                                        ? 'border-red-600 text-red-600 hover:bg-red-50'
                                        : currentAffiliateProduct.buttonColor === 'purple'
                                  ...
                                  : `text-white ${
                                      currentAffiliateProduct.buttonColor === 'green'
                                        ...
                                        : currentAffiliateProduct.buttonColor === 'red'
                                        ? 'bg-gradient-to-r from-red-600 to-pink-600 hover:shadow-red-500/25'
                                        : currentAffiliateProduct.buttonColor === 'purple'
                            ...
                            animate={
                              currentAffiliateProduct.buttonAnimation === 'hover-pulse'
                                ? { scale: [1, 1.02, 1] }
                                : {}
                            }
                            transition={{
                          ...
                          >
                            {currentAffiliateProduct.buttonIcon && currentAffiliateProduct.buttonIcon !== 'none' && (
                              <span>
                                {currentAffiliateProduct.buttonIcon === 'shopping-cart' && (
                                  <ShoppingCart
                                    size={
                                      currentAffiliateProduct.buttonSize === 'small'
                                        ? 14
                                ...
                                {currentAffiliateProduct.buttonIcon === 'external-link' && (
                                  <ExternalLink
                                    size={
                                      currentAffiliateProduct.buttonSize === 'small'
                                        ? 14
                                ...
                                {currentAffiliateProduct.buttonIcon === 'heart' && (
                                  <span
                                    className={
                                      currentAffiliateProduct.buttonSize === 'small'
                                        ? 'text-sm'
                                ...
                                {currentAffiliateProduct.buttonIcon === 'star' && (
                                  <span
                                    className={
                                      currentAffiliateProduct.buttonSize === 'small'
                                        ? 'text-sm'
                                ...
                                {currentAffiliateProduct.buttonIcon === 'arrow-right' && (
                                  <span
                                    className={
                                      currentAffiliateProduct.buttonSize === 'small'
                                        ? 'text-sm'
              ...
              <div>
                ...
                <div className="mb-2 text-xs text-gray-600 bg-blue-50 p-2 rounded">
                  <strong>Formatierungs-Tipps:</strong> <code className="mx-1">[TIPP]</code> für blaue Tipp-Boxen,{' '}
                  <code className="mx-1">[WICHTIG]</code> für orange Wichtig-Boxen, <code className="mx-1">[WARNUNG]</code> für
                  rote Warnungs-Boxen
                </div>
                <textarea
...
**Fetter Text** und *kursiver Text* werden unterstützt."
      ...
      <AnimatePresence>
        {showAnimalManager && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                ...
                <button onClick={() => setShowAnimalManager(false)} className="text-gray-500 hover:text-gray-700 transition-colors">
                  <X size={24} />
                </button>
              </div>
              ...
              <div className="p-6 space-y-6">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <button onClick={handleAddAnimalType} className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-300">
                      Hinzufügen
                    </button>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {animalTypes.map((type) => (
                      <div key={type.id} className="bg-white border border-gray-200 rounded-lg p-4 flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          <div className={`w-10 h-10 rounded-lg bg-gradient-to-r ${type.color} flex items-center justify-center text-white font-bold`}>{type.icon}</div>
                          <span className="font-medium text-gray-900">{type.name}</span>
                        </div>
                        <button onClick={() => handleDeleteAnimalType(type.id)} className="text-red-600 hover:text-red-800 p-1">
                          <Trash2 size={16} />
                        </button>
                      </div>
                    ))}
              ...
              <div className="flex items-center justify-end p-6 border-t border-gray-200">
                <button onClick={() => setShowAnimalManager(false)} className="px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors">
                  Schließen
                </button>
              </div>
            </motion.div>
      ...
      <AnimatePresence>
        {showUserManager && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="bg-white rounded-xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <div className="flex items-center space-x-3">
                ...
                <button onClick={() => setShowUserManager(false)} className="text-gray-500 hover:text-gray-700 transition-colors">
                  <X size={24} />
                </button>
              </div>
              ...
              <div className="p-6 space-y-6">
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <button onClick={handleAddUser} className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-300 font-semibold">
                      Hinzufügen
                    </button>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-blue-700 text-sm space-y-1">
                        ...
                        <p>
                          <strong>✏️ Editor:</strong> Kann Artikel erstellen, bearbeiten und veröffentlichen
                        </p>
                        <p>
                          <strong>📝 Autor:</strong> Kann eigene Artikel erstellen und bearbeiten
                        </p>
                        <p>
                          <strong>🛡️ Moderator:</strong> Kann Kommentare und Inhalte moderieren
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex items-center justify-end p-6 border-t border-gray-200">
                <button onClick={() => setShowUserManager(false)} className="px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors">
                  Schließen
                </button>
              </div>
            </motion.div>
      ...
      <AnimatePresence>
        {showAIGenerator && <AIContentGenerator onGenerate={handleAIGenerate} onClose={() => setShowAIGenerator(false)} />}
      </AnimatePresence>
    </div>
  );
}
